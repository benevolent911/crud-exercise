...
<div class="row">
	...
	<div class="col-md-9 col-md-offset-0 col-sm-8 col-sm-offset-0 col-xs-10 col-xs-offset-1">
		<div class="row">
			<h1 class="text-center text-primary"><span class="glyphicon glyphicon-book"></span> Edit Book</h1>
			<form action="{{route('books.update', ['id' => $book->id])}}" method="POST" class="form-horizontal">
				{{ method_field('PUT') }} {{ csrf_field() }}
				<div class="form-group">
					<label for="title" class="col-sm-2 control-label">Title</label>
					<div class="col-sm-10">
						<input type="title" class="form-control" id="title" name="title" placeholder="title" value="{{$book->title}}">
					</div>
				</div>
				<div class="form-group">
					<label for="author" class="col-sm-2 control-label">Author</label>
					<div class="col-sm-10">
						<input type="author" class="form-control" id="author" name="author" placeholder="author" value="{{$book->author}}">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class = "form-control" id = "library_section" name = "library_section">
							<option selected>{{$book->library_section}}</option>
