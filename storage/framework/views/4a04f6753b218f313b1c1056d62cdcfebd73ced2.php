<div class="col-md-3 col-md-offset-0 col-sm-4 col-sm-offset-0 col-xs-6 col-xs-offset-3 well well-lg">
	...
	<?php if(auth()->user() == null || auth()->user()->role == 'user'): ?>
	<form action="<?php echo e(route('books.search')); ?>" class="form-horizontal" method="GET"> 
		<?php else: ?>                        
	<form action="<?php echo e(route('admin.search')); ?>" class="form-horizontal" method="GET">
		<?php endif; ?>   
